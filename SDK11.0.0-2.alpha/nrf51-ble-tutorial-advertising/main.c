...
#define APP_ADV_TIMEOUT_IN_SECONDS       180                                          /**< The advertising timeout in units of seconds. Zero equals infinite advertising. */
 ...
 * This function initializes timers used by the Softdevice
 */
...
static void ble_stack_init(void)
{
    ...
    // Tell the softdevice which function is to be called i case of a BLE event.
    err_code = softdevice_ble_evt_handler_set(ble_evt_dispatch);
    APP_ERROR_CHECK(err_code);

    // Tell the softdevice which function is to be called i case of a SYSTEM event.
